...
func TestFunctions_ListTriggers(t *testing.T) {
	...
	triggers, _, err := client.Functions.Triggers(ctx, "123-456")
	require.NoError(t, err)
...
func TestFunctions_GetTrigger(t *testing.T) {
	...
	trigger, _, err := client.Functions.Trigger(ctx, "123-456", "my-trigger")
	require.NoError(t, err)
...
func TestFunctions_CreateTrigger(t *testing.T) {
	...
	opts := FunctionsTriggerCreateOptions{
		Name:      "my-new-trigger",
		Function:  "my_func",
		Type:      "SCHEDULED",
		IsEnabled: true,
...
func TestFunctions_UpdateTrigger(t *testing.T) {
	...
	opts := FunctionsTriggerUpdateOptions{
		IsEnabled: false,
	}
